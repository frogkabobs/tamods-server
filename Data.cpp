...
namespace Data
{
    ...
    std::map<std::string, int> projectiles = {
        ...
        { R"rx(^(medium(spinfusor|spin))$)rx", CONST_PROJ_ID_SPINFUSOR },
        ...
        { R"rx(^(heavyboltlauncher)$)rx", CONST_PROJ_ID_HEAVY_BOLT_LAUNCHER },
        ...
        { R"rx(^(heavyblinks?(fusor)?)$)rx", CONST_PROJ_ID_HEAVY_SPINFUSOR_MKD },
        { R"rx(^(mediumtwinfusor)$)rx", CONST_PROJ_ID_TWINFUSOR },
        { R"rx(^(heavytwinfusor)$)rx", CONST_PROJ_ID_HEAVY_TWINFUSOR },
        ...
        { R"rx(^(lightspin(fusor)?)$)rx", CONST_PROJ_ID_LIGHT_SPINFUSOR },
        { R"rx(^(lightblinks?(fusor)?)$)rx", CONST_PROJ_ID_LIGHT_SPINFUSOR_100X },
        ...
        { R"rx(^(lighttwinfusor)$)rx", CONST_PROJ_ID_LIGHT_TWINFUSOR },
        ...
        { R"rx(^(mediumblinks?(fusor)?|sparespin(fusor)?)$)rx", CONST_PROJ_ID_SPINFUSOR_100X },
